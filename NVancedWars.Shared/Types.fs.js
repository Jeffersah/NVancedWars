...
import { option_type, record_type, union_type, string_type } from "../NVancedWars.UI/src/fable_modules/fable-library.4.0.1/Reflection.js";
...
export function AccountCommands$reflection() {
    return union_type("NVancedWars.Shared.AccountCommands", [], AccountCommands, () => [[["Item1", LoginRequest$reflection()], ["Item2", IReplyChannel$1$reflection(union_type("Microsoft.FSharp.Core.FSharpResult`2", [PlayerToken$reflection(), string_type], FSharpResult$2, () => [[["ResultValue", PlayerToken$reflection()]], [["ErrorValue", string_type]]]))]], [["Item1", LoginRequest$reflection()], ["Item2", IReplyChannel$1$reflection(option_type(PlayerToken$reflection()))]], [["Item1", PlayerToken$reflection()], ["Item2", IReplyChannel$1$reflection(option_type(string_type))]], [["Item1", string_type], ["Item2", string_type], ["Item3", IReplyChannel$1$reflection(option_type(PlayerToken$reflection()))]]]);
}
